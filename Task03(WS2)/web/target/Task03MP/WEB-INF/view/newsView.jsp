...
<div class="leftform">
	...
	<textarea class="areaBorderless" readonly rows="35" cols="60"
		name="TxtA002" maxlength="2048"><c:out value = "${news.content}"/></textarea>
</div>
<div>
	<div class="bottomright">
		<form:form
			action="http://localhost:8080/web/${localeCode}/addNewsForm/${news.id}">
			<button>
				<spring:message code="Lbl.EDIT" />
			</button>
		</form:form>
		<form:form action="http://localhost:8080/web/${localeCode}/delete"
			modelAttribute="news">
