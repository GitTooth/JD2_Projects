	...
	<form:form action = "http://localhost:8080/Task03_3/News/update" modelAttribute = "news">
		<form:hidden path="id" value="${news.id}"/>
		  <div class = "leftform">
		  		...
		  		<form:input path = "title" size="60" name="Txt001" maxlength="100" value = "${news.title}"/>
		  		<br/>
		  ...
		  <div class = "leftform">
		  		...
		  		<form:input path = "date" size="20" name="Txt003" maxlength="10" value = "${news.getDateString()}"/>
		  		<br/>
		  ...
		  <div class = "leftform">
 		  ...
 		  <div>
	  		  <div style = "position: absolute; bottom: 10%;right: 55%;"> 		
	  		  		<button><spring:message code="Lbl.SAVE"/></button>
	  		  </div>
 		  </div>
	  </form:form>
	  <form:form action = "http://localhost:8080/Task03_3/News/NewsListForm">
